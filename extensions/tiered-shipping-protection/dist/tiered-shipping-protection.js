...
${errorInfo.componentStack}`);
  ...
  // extensions/tiered-shipping-protection/src/Checkout.jsx
  var import_react15 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var Checkout_default = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TieredShippingProtection, {}));
  function TieredShippingProtection() {
    const translate = useTranslate();
    const applyCartLinesChange = useApplyCartLinesChange();
    const cartLines = useCartLines();
    const [isChecked, setIsChecked] = (0, import_react15.useState)(false);
    const [shippingProtectionVariantId, setShippingProtectionVariantId] = (0, import_react15.useState)(null);
    ...
    const handleCheckboxChange = (checked) => __async(this, null, function* () {
      ...
      if (checked && shippingProtectionVariantId) {
        ...
        yield addShippingProtection(
          applyCartLinesChange,
          shippingProtectionVariantId
        );
      } else {
        console.log("Removing shipping protection");
        yield removeShippingProtection(
          applyCartLinesChange,
          cartLines,
          shippingProtectionVariantId
        );
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "Worry-Free Protection", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "from damage, loss, and theft ." }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: isChecked, onChange: handleCheckboxChange, children: translate("Add Tiered Shipping Protection") })
    ] });
  }
  ...
  function addShippingProtection(applyCartLinesChange, variantId) {
    return __async(this, null, function* () {
      console.log("Applying addCartLine change for variant ID:", variantId);
      const response = yield applyCartLinesChange({
        type: "addCartLine",
  ...
  function removeShippingProtection(applyCartLinesChange, cartLines, shippingProtectionVariantId) {
    return __async(this, null, function* () {
      console.log(
...
//# sourceMappingURL=tiered-shipping-protection.js.map
