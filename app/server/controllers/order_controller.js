...
//       api_secret:
//         "dsk.$2y$10$spOBIJMUljW29Bbt9s7R.uzOPbCjaRj6r.QS8hEGUHKUcUOasq4hG", // Your secret key
//       first_name: customerDetails.firstName,
//       last_name: customerDetails.lastName,
//       request_for: customerDetails.email,
//       country_code: "1", // Assuming it's a US customer
...
//     // Send the payment request to Dfin
//     const paymentRequest = new PaymentRequest(
//       "dpk.$2y$10$ESj1rY1O6wYEWNTNyOwKiOD7/6apHCxyNnjbBrC1Cn//AbJGQAJxa"
//     ); // Your public key

//     const dfinResponse = await paymentRequest.post(paymentRequestData);

//     // Return the Dfin response (or handle it as needed)
//     return res.status(200).json({
//       orderDetails,
//       customerDetails,
//       lineItems,
...
// // Dfin Payment Request class (provided in reference)
// class PaymentRequest {
//   constructor(token) {
//     this.token = token;
//     this.baseUrl = "https://sell.dfin.ai/api/request-payment";
//   }
