...
// };
// const fetchOrderDetails = async (shopifyOrderId, accessToken, SHOP) => {
//   const url = `https://${SHOP}/admin/api/2024-04/orders/${shopifyOrderId}.json`;
//   try {
...
//   }
// };
// const fetchOrderTransactions = async (shopifyOrderId, accessToken, SHOP) => {
...
// const markOrderAsPaid = async (shopifyOrderId, session) => {
...
// export const handleOrderUpdated = async (payload, req) => {
...
//       const paymentResponse = await markOrderAsPaid(shopifyOrderId, session);
...
//         console.log(`Order ${shopifyOrderId} is already marked as paid`);
...
// //     await updateShopifyOrderStatus(shopifyOrderId, newStatus);

// //     return {
// //       success: true,
// //       message: "WooCommerce order status updated in Shopify",
// //     };
// //   } catch (error) {
// //     console.error("Error handling WooCommerce webhook:", error);
// //     return { error: "Internal Server Error" };
...
// //   const url = `https://${SHOP}/admin/api/2024-04/orders/${orderId}.json`;
...
// //       },
// //     });
// //     console.log(`Updated Shopify order ${orderId} status to ${status}`);
// //   } catch (error) {
// //     console.error(`Failed to update Shopify order status:`, error);
// //   }
// // }

// export const handleProductCreated = async (payload, req) => {
//   if (!payload) {
...
// export const handleProductUpdated = async (payload, req) => {
...
// export const handleProductDeleted = async (payload, req) => {
//   if (!payload) {
//     console.error("Payload is undefined");
//     return;
//   }
...
//   }
// };
// export const handleOrderCreated = async (payload, req) => {
...
// export const handleDeleteOrder = async (payload, req) => {
//   try {
//     // const shop = process.env.SHOP;
//     // const session = await getSessionFromDB(shop);
//     const session = req.shop.session;
